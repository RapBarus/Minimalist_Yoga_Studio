...
<head>
    ...
    <title>Konfirmasi Membership | Minimalist Studio</title>
...
<body>
    <div class="page">
        <div class="topbar">
            ...
            <span class="topbar-title">Konfirmasi Membership</span>
        </div>
        ...
        <div class="content">
            ...
            <div class="package-card">
                ...
                @if ($package->class_name)
                    <div class="class-tag">{{ $package->class_name }}</div>
                @endif
                <div class="package-meta">
                    ...
                    <div class="package-meta-row">
                        ...
                        {{ $package->quota_amount }}x Pertemuan
                    </div>
                </div>
            </div>
    ...
    <script>
        function handlePayment() {
            window.location.href = '{{ route('membership.payment.method', $package->package_id) }}';
        }
    </script>
</body>
